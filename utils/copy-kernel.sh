...
#  Writes the kernel onto a floppy in $floppydev.  Note that the floppy 
...
echo ""
echo "Copying Visopsys kernel to $floppydev"
...
#  Copy the kernel.  We don't need to error-check that the previous
#  write was successful.
echo -n "Copying kernel...  "
/bin/cp $kernel $FLOPPYDIR/
