...
#define FD_CLOEXEC  0x1   // Close the file descriptor upon execution of an
...
#define O_DSYNC    0x11  // Write according to synchronised I/O data
                         // integrity completion. 
#define O_NONBLOCK 0x12  // Non-blocking mode. 
#define O_RSYNC    0x14  // Synchronised read I/O operations. 
#define O_SYNC     0x18  // Write according to synchronised I/O file
                         // integrity completion. 

// Mask for use with file access modes: 
#define O_ACCMODE  0x20  // Mask for file access modes. 

// File access modes used for open() and fcntl(): 
#define O_RDONLY   0x21  // Open for reading only. 
#define O_RDWR     0x22  // Open for reading and writing. 
#define O_WRONLY   0x24  // Open for writing only. 

// The symbolic names for file modes for use as values of mode_t are
// defined as described in <sys/stat.h>. 

// The off_t, pid_t, and mod_t types are defined as described in
// <sys/types.h>.
#include <sys/types.h>
