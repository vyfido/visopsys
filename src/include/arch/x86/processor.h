...
// This file contains x86-specific definitions and macros.
...
#define X86_FPU_STATE_LEN				108
#define X86_IO_PORTS					65536
#define X86_PORTS_BYTES					(X86_IO_PORTS / 8)
#define X86_IOBITMAP_OFFSET				0x68
...
typedef volatile struct {
	...
	unsigned char IOMap[X86_PORTS_BYTES];

} __attribute__((packed)) x86TSS;
...
#define processorGetPageDir(addr) processorGetCR3(addr)

#define processorSetPageDir(addr) processorSetCR3(addr)
