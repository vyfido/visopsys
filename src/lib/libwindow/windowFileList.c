...
#define DEFAULT_INSTALLICON_VAR		"icon.install"
#define DEFAULT_INSTALLICON_FILE	PATH_SYSTEM_ICONS "/install.ico"
...
static typeIcon iconList[] = {
	...
	{ LOADERFILECLASS_INSTALL, LOADERFILESUBCLASS_NONE, DEFAULT_INSTALLICON_VAR,
		DEFAULT_INSTALLICON_FILE, instImageIndex },
