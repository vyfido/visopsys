...
;; The LBA number of the boot sector to load
%define BOOTSECTOR		(DISKPACKET + DISKPACKET_SZ)
%define BOOTSECTOR_SZ		DWORD
		
;; The offset of the partition table entry we're loading
%define BOOTPARTITION		(BOOTSECTOR + BOOTSECTOR_SZ)
