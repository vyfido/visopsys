...
%define ERR_TIMEOUT        10
	...
	GLOBAL kernelHardDiskDriverInitialize
	GLOBAL kernelHardDiskDriverReset
	GLOBAL kernelHardDiskDriverRecalibrate
	GLOBAL kernelHardDiskDriverReadSectors
	GLOBAL kernelHardDiskDriverWriteSectors
	GLOBAL kernelHardDiskDriverLastErrorCode
	GLOBAL kernelHardDiskDriverLastErrorMessage
	GLOBAL kernelHardDiskDriverReceiveInterrupt
...
LBASetup:
	...
	;; void CHSSetup(unsigned int LBAAddress);
	;; It doesn't return anything.
...
kernelHardDiskDriverInitialize:
...
kernelHardDiskDriverReset:
	;; Does a software reset of the requested disk controller.
	;; int kernelHardDiskDriverReset(int diskNumber);
...
kernelHardDiskDriverRecalibrate:
	;; Recalibrates the requested drive, causing it to seek to track 0
	;; int kernelHardDiskDriverRecalibrate(int diskNumber);
...
kernelHardDiskDriverReadSectors:
	...
	;; int kernelHardDiskDriverReadSectors(int diskNum, int head,
	;;	 int cylinder, int startSector, unsigned int LBA,
	...
	add EDI, dword [BYTESREAD]	; add bytes read so far
...
kernelHardDiskDriverWriteSectors:
...
kernelHardDiskDriverLastErrorCode:
...
kernelHardDiskDriverLastErrorMessage:
...
kernelHardDiskDriverReceiveInterrupt:
