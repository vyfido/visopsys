		   ...
		   kernelAsciiFont **pointer)
{
  ...
  *pointer = NULL;
  ...
  newFont = kernelMemoryRequestSystemBlock(sizeof(kernelAsciiFont), 0,
					   "font info");
  fontData = kernelMemoryRequestSystemBlock((charBytes * ASCII_PRINTABLES), 0,
					    "font data");
  ...
  kernelMemoryReleaseBlock(fontImage.data);
