...
//
//  kernelGraphicFunctions.h
//
	
// This goes with the file kernelGraphicFunctions.c

#if !defined(_KERNELGRAPHICFUNCTIONS_H)
...
typedef struct
{
  ...
  int (*driverDrawMonoImage) (kernelGraphicBuffer *, image *,
			      color *, color *, int, int);
  int (*driverDrawImage) (kernelGraphicBuffer *, image *, int, int);
...
typedef struct 
{
  ...
  kernelGraphicDriver *deviceDriver;

} kernelGraphicAdapterObject;


// Functions exported by kernelGraphicFunctions.c
int kernelGraphicRegisterDevice(kernelGraphicAdapterObject *);
int kernelGraphicInstallDriver(kernelGraphicDriver *);
...
int kernelGraphicDrawOval(kernelGraphicBuffer *, color *, drawMode, int, int,
			  unsigned, unsigned, unsigned, int);
int kernelGraphicDrawImage(kernelGraphicBuffer *, image *, int, int);
...
#define _KERNELGRAPHICFUNCTIONS_H
#endif
