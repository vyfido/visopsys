...
Jim Boemler (jboemler@halcyon.com)
  ...
  This header created on Sat Oct 17 11:08:14 PDT 2009
...
PCI_DEVTABLE	PciDevTable [] =
  {
    ...
    { 0x8086, 0x10F5, "82567LM", "IntelÂ®  82567LM-2 Gigabit Network Connection" } ,
    ...
    { 0x8086, 0x1227, "82801db ich3", "LAN Controller with 82562EM/EX PHY	PCI" } ,
    ...
    { 0x8086, 0x2930, "8086", "29D4 hp dv5" } ,
    ...
    { 0x1180, 0x0843, "R5C853", "Ricoh SD/MMC ÐŸÑ€Ð¸Ð½Ð¸Ð¼Ð°ÑŽÑ‚ Ð”Ð¸Ñ&#65533;Ð¿ÐµÑ‚Ñ‡ÐµÑ€Ð°" } ,
    ...
    { 0x14F1, 0x5045, "4.0.3.1", "dddDAUDIO Soft Data fax Modem with SmartPC / Conexant High Definition SmartAudio HD2" } ,
    ...
    { 0x0A5C, 0x2151, " ", "Broadcom 2046 Bluetooth 2.1 USB Dongle" } ,
    ...
    { 0x168C, 0x001c, "Vaio VGN cr3ZR/R", "" } ,
    ...
    { 0x1043, 0x1969, "", "Attansic L1 Gigabit Ethernet 10/100/1000Base-T Adapter" } ,
    ...
    { 0x104C, 0x803B, "", "Texas Instruments PCIxx12 Integrated FlashMedia Controller" } ,
    ...
    { 0x10DE, 0x00C8, "NV41", "NVIDIA GeForce Go 6800" } ,
    ...
    { 0x10EC, 0x0888, "ALC889", "Realtek 7.1+2 High Definition Audio" } ,
    { 0x10EC, 0x8021, "RTL8029AS", "NIC" } ,
    { 0x10EC, 0x8029, "RTL8029(AS)", "PCI Full-Duplex Ethernet Controller with PnP Function" } ,
    ...
    { 0x1102, 0x7003, "EMU10K2 (for Vista 32 bit)", "Creative Labs SB Audigy MIDI/Game port" } ,
    ...
    { 0x1106, 0x1106, "060000A1106", "ISA Bridge w/IDE" } ,
    ...
    { 0x1131, 0x7160, "Philips SAA7160E, TDA10046 and TDA8275A", "-" } ,
